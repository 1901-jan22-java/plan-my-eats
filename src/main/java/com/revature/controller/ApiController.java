...
public class ApiController {
	...
	public ResponseEntity<RecipeDetailsResults> hitRecApi(@RequestBody String params) {
		String[] filters = params.split(";");
		String apiUrl = "https://api.edamam.com/search?q=" + filters[0] + "&app_id=3ee293b7&app_key=5143a3f492a353eb02eac1fac6912dbc&from=0&to=3&calories=" + filters[1] + "&health=" + filters[2];
		System.out.println(apiUrl);
