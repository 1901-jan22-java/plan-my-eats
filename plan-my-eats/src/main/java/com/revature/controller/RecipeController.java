...
public class RecipeController 
{
	...
	public ResponseEntity<RecipeDetailsResults> hitRecApi(@RequestBody User u)
	{
		...
		if(u.getGender() == "male")
		{
			calories = 66.4730d + (13.7516 * (u.getWeight() * 0.4539d)) + (5.0033d * (u.getHeight() * 2.54d)) - (6.7550 * u.getAge());
			calories *= 1.2d;
		}
		else if (u.getGender() == "female")
		{
			calories = 655.0955d + (9.5634d * (u.getWeight() * 0.4539d)) + (1.8496d * (u.getHeight() * 2.54d)) - (4.6756d * u.getAge());
			calories *= 1.2d;
		}
		...
		String apiUrl = "https://api.edamam.com/search?q=" + "&app_id=3ee293b7&app_key=5143a3f492a353eb02eac1fac6912dbc&from=0&to=3&calories=" + (int)(calories * 0.33d) + "&health=" + filters[0] + "+" + filters[1];
